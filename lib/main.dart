...
import 'package:hk4_sallah/shared/network/local/observer.dart';
...
import 'package:hk4_sallah/shared/style/style.dart';
...
import 'modules/category/category_details/category_details.dart';
import 'modules/favorits/favorite.dart';
...
import 'modules/settings/component/address_details.dart';
import 'modules/settings/component/address_screen.dart';
...
void main() async {
  ...
  bool? status = StoragePref.getValue(key: 'seeBoarding');
  // StoragePref.removeValue('token');
  token = StoragePref.getValue(key: 'token');
  language = StoragePref.getValue(key: 'lang') ?? 'en';
  isDark = StoragePref.getValue(key: 'isDark') ?? false;
